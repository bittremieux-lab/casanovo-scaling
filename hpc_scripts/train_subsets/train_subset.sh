...
for NUM_SPECTRA in 1 2 5 10 20; do
  for NUM_PEP in 100000 250000 500000 750000 1000000; do
    ...
    qsub hpc_scripts/train_subsets/train_subset.pbs -v TRAIN_FILE=$TRAIN_FILE,VAL_FILE=$VAL_FILE,TEST_FILE=$TEST_FILE,OUTPUT_DIR=$OUTPUT_DIR
    echo hpc_scripts/train_subsets/train_subset.pbs -v TRAIN_FILE=$TRAIN_FILE,VAL_FILE=$VAL_FILE,TEST_FILE=$TEST_FILE,OUTPUT_DIR=$OUTPUT_DIR
  done
done